...
Solving Problem on glpk, a Mixed Integer Linear Programming (MILP) Solver
--------------------------------------------------------------------------

An Example File

*  `Chicken, Rice and Veggies model file for glpk solver <../../../files/other/snack_glpk_1700248493.lp>`_


For example, user could use the following command to solve problem in linux

* glpsol --lp snack_glpk_1700248493.lp -o snack_glpk_1700248493.sol
